...
<script src="{{ asset('assets/js/jquery/jquery-2.1.1.min.js') }}"></script>
<script src="{{ asset('assets/js/jquery/ui/1.10.4/jquery-ui.js') }}"></script>
<script src="{{ asset('assets/js/jquery/jquery-migrate-1.2.1.min.js') }}"></script>
<!--[if lt IE 9]>
...
<script src="{{ asset('assets/js/jquery.supr.js') }}"></script>
<script src="{{ asset('assets/js/main.js') }}"></script>
<script src="{{ asset('assets/js/pages/blank.js') }}"></script>
<script src="{{ asset('assets/plugins/forms/bootstrap-filestyle/bootstrap-filestyle.js') }}"></script>
<script src="{{ asset('assets/plugins/forms/fancyselect/fancySelect.js') }}"></script>
...
<script src="{{ asset('assets/plugins/ui/bootstrap-sweetalert/sweet-alert.js') }}"></script>
